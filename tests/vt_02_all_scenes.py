...
for current_path in os.listdir("../scenes"):
    ...
    bpy.ops.export_scene.gltf(filepath="../scenes/" + current_file + ".gltf", check_existing=True, export_copyright="", export_layers=False, export_tangents=True, export_skins=True, export_morph=True, export_bake_skins=False, export_embed_buffers=False, export_force_indices=False, export_colors=True, export_animations=True, export_unlit=False, export_texcoords=True, export_materials=True, export_embed_images=False, export_indices='UNSIGNED_SHORT', export_camera_infinite=False, export_selected=False, export_strip=False, export_normals=True, export_apply=False, export_cameras=True, export_current_frame=True, export_lights_cmn=False, export_extras=False, export_displacement=False, filter_glob="*.gltf")
